...
import kr.co.mostx.japi.service.AssetDepreciationService;
import kr.co.mostx.japi.service.AssetService;
...
public class AssetDepreciationController {
    ...
    public List<AssetDashboardDTO> dashBoard() {
        return assetDashboardRepository.findDashboard();
    }
    ...
    public AssetResponsePageInfo findAll(@RequestParam(required = false, defaultValue = "1") int page,
    ...
    public AssetResponsePageInfo findDisposalAll(@RequestParam(required = false, defaultValue = "1") int page,
                                                 @RequestParam(required = false, defaultValue = "10") int size) {
    ...
    public AssetResponse<List<AssetDetailDTO>> findAssetDepreciationSearch(@ModelAttribute AssetDepreciationSearchDTO assetDepreciationSearchDto){
    ...
    public AssetResponsePageInfo findSearchAsset(@ModelAttribute AssetSearchDTO assetSearchDto,
    ...
    public AssetResponsePageInfo findDisposalSearchAsset(@ModelAttribute AssetDisposalSearchDTO assetDisposalSearchDto,
                                                         @RequestParam(required = false, defaultValue = "1") int page,
                                                         @RequestParam(required = false, defaultValue = "10") int size) {
    ...
    public AssetResponsePageInfo findDepreciation(@PathVariable("assetCodeSno") Long assetCodeSno,
                                                  @RequestParam(required = false, defaultValue = "1") int page,
